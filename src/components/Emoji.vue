<template>
  <div class="emoji">
    <div class="emoji-header">
      <!-- Back btn -->
      <div class="emoji-header_back" @click="close">
    ...
    <div v-if="listEmoji && listEmoji.length" class="emoji-list">
      <span v-for="(e, i) of listEmoji" :key="i" :title="e.name" @click="select(e)">
        {{ e.char }}
      </span>
    </div>
    <div v-else class="emoji-list_empty">Not found</div>
  </div>
</template>

<script lang="ts">
import { computed, defineComponent, ref } from 'vue';
import { BACK_BTN_ICON } from '../config';
